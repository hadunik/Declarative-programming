...
{--
grandfather':: Sheep -> Tree Sheep -> Maybe Sheep
grandfather' _ (Leaf _) = Nothing
grandfather' s t = (mother1 >=> father1) s where 
        mother1 s = mother' s t
        father1 s = father' s t
--}
